# Gemini CLI Project Instructions -- Trale
...
- **Avoid Magic Numbers:** Do not use manually defined constant paddings, margins, or sizes in your code. Instead, use the appropriate constants or theme-provided spacing variables to ensure consistency across the UI.
...
- Prefer const constructors, single quotes, 80 char line limit. Always run `dart format .` to format the code before committing.
