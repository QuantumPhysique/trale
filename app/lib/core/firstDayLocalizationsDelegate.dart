...
class FirstDayMaterialLocalizationsDelegate
  ...
  /// Convert a TraleFirstDay enum value to the 0-based index used by fl
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    ...
    if (override == null) {
      // "Default" – just return the standard localizations unchanged.
      return base;
    }
    return _FirstDayMaterialLocalizations(base, override);
  }

  @override
  bool shouldReload(FirstDayMaterialLocalizationsDelegate old) =>
      firstDay != old.firstDay;
}

class _FirstDayMaterialLocalizations implements MaterialLocalizations {
  const _FirstDayMaterialLocalizations(this._base, this._firstDay);
