...
Extended in: feature/checkin-ui-refactor (adds full UI integration)

Linear: SUN-6 marked as Done

Next steps: 
- PR for feature/checkin-ui-refactor (extends DB with full UI)
- After merge, cleanup feature branches